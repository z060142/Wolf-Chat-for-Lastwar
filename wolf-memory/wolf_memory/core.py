    ...
    messages = [
        {
            "role": "system",
            "content": (
                f"You are compressing recent conversation activity for the user '{username}' "
                "into a compact record to be injected as live context at the start of a conversation. "
                "Your job is to record and compress — not to comment, evaluate, or draw conclusions.\n\n"
                "## Input format\n"
                ...
                "## Output requirements\n"
                "Write 2 to 4 sentences covering only what is directly observable in the log:\n"
                "1. What topics or content this user brought up in recent interactions.\n"
                "2. Any specific requests, actions, or notable things they said or did.\n"
                "3. The most recent exchange — what they said last and what the bot replied.\n\n"
                "## Constraints\n"
                "- Maximum 500 characters.\n"
                "- State only what happened. Do not interpret motives, assess personality, "
                "or characterise the relationship.\n"
                "- Plain prose only. No bullet points, no headers, no preamble.\n"
                "- Write in English only. You may quote specific phrases from the log verbatim "
                "if they are distinctive or worth preserving, but all surrounding text must be English.\n"
